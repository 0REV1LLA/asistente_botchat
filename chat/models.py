...
class Venta(models.Model):
    class MetodoPago(models.TextChoices):
        PAGO_MOVIL = 'Pago Movil', 'Pago Movil'
        ...
        BIO_PAGO = 'Bio Pago', 'Bio Pago'
        OTRO = 'Otro Método', 'Otro Método'
    ...
    cliente = models.ForeignKey(Clientes, on_delete=models.SET_NULL, db_column='cliente', blank=True, null=True)

    @property
    def detalles(self):
        return self.detallesventa_set.all()
...
class DetallesVenta(models.Model):
    ...
    id_producto = models.ForeignKey(Productos, on_delete=models.SET_NULL, db_column='id_producto', blank=True, null=True)
    venta = models.ForeignKey(Venta, models.DO_NOTHING)
    fecha = models.DateField(default=date.today, blank=True, null=True)
    hora = models.TimeField(default=timezone.now, blank=True, null=True)
